  ...
  <div>
    <el-form ref="elForm" :model="formData" :rules="rules" size="small" label-width="100px">
      <el-form-item label="计数器" prop="field120">
        <el-input-number v-model="formData.field120" placeholder="计数器" :step='1'></el-input-number>
      </el-form-item>
      <el-form-item label="编辑器" prop="field124">
        <tinymce v-model="formData.field124" placeholder="请输入编辑器" :height="300"></tinymce>
      </el-form-item>
